 ...
 * generated in the na.rss package.
...
public class ObjectFactory {
    ...
    private final static QName _Rss_QNAME = new QName("", "na/rss");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: na.rss
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "na/rss")
